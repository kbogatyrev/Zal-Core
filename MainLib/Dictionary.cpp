...
ET_ReturnCode CDictionary::ePopulateWordFormDataTables()
{
    ...
    wcout << endl << endl << "****      GENERATING WORDFORMS" << endl << endl;

    clock_t totalTime = 0;

    vector<shared_ptr<CInflection>> vecProcessedInflections;
    vector<shared_ptr<CLexeme>> vecProcessedLexemes;
